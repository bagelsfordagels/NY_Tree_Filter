...
app.get("/api/filter", async (req, res) => {
  ...
  try {
    ...
    let sql = "SELECT T.species, T.CommonName, T.AGCT, T.ACProd, T.NWIStatus, L.FloodPlainBottomLand, L.UplandMesic, L.UplandDry FROM Trees T LEFT JOIN LandfromPref L ON T.TreeId = L.TreeId";
    const where = []; 
    const params = [];
