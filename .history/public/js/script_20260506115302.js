...
await Promise.all([
    populateDropdown("filterAGCT", "Trees", "AGCT"),
    populateDropdown("filterACProd", "Trees", "ACProd"),
    populateDropdown("filterSpecies", "Trees", "species"),
    populateDropdown("filterCommon", "Trees", "CommonName"),
    populateDropdown("filterNWI", "Trees", "NWIStatus"),
    populateDropdown("filterSoilAcidTol", "SiteChemPref", "SoilAcidTol"),
    populateDropdown("filterSoilAlkTol", "SiteChemPref", "SoilAlkTol"),
    populateDropdown("filterSoilSaltTol", "SiteChemPref", "SoilSaltTol"),
    populateDropdown("filterGrowthRate", "SpeciesCharacteristics", "GrowthRate"),
    populateDropdown("filterShadeTolerance", "SpeciesCharacteristics", "ShadeTol"),
    populateDropdown("filterDeer", "PlantingConsiderations", "DeerResistance"),
    populateDropdown("filterPest", "PlantingConsiderations", "PestAndPathogenSusceptibility"),
]);
